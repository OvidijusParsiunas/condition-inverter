...
suite.only('Partial Outside Statement Inversion Suite', () => {
  [
    {
      input: `and`,
      output: 'or',
    ...
    { input: '(dog + cat) ? ', output: '!(dog + cat) ? ' },
    { input: `dog >>>= mouse ? `, output: '!(dog >>>= mouse) ? ' },
    { input: `dog >>>= mouse ? `, output: '!(dog >>>= mouse) ? ' },
    { input: `dog >= mouse ? `, output: 'dog < mouse ? ' },
    { input: `dog <= mouse ? `, output: 'dog > mouse ? ' },
    { input: `dog > mouse ? `, output: 'dog <= mouse ? ' },
    ...
    { input: `dog <<= mouse ? `, output: '!(dog <<= mouse) ? ' },
    { input: `dog << mouse ? `, output: '!(dog << mouse) ? ' },
    { input: `cat && dog >>= mouse ? `, output: '!cat || !(dog >>= mouse) ? ' },
    { input: `dog >>= mouse && cat ? `, output: '!(dog >>= mouse) || !cat ? ' },
    { input: `dog >> mouse ? `, output: '!(dog >> mouse) ? ' },
    { input: `dog === mouse ? `, output: 'dog !== mouse ? ' },
    { input: `dog & mouse ? `, output: '!(dog & mouse) ? ' },
    { input: `dog | mouse ? `, output: '!(dog | mouse) ? ' },
