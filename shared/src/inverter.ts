...
export default class Inverter {
    static invertIfStatements(tokens: any[], conditionIndexes: { start: any; end: any; brackets: any; hasFollowupEquals: any; removeNegationBrackets: any; revertBooleanLiteral: any; }[]) {
        let newElementsDelta = 0;
        conditionIndexes.forEach(({ start, end, brackets, hasFollowupEquals, removeNegationBrackets, revertBooleanLiteral }: any, conditionIndexesCurrentIndex: number) => {
